   <!--main content end-->
      ...
      <footer class="site-footer">
          <div class="text-center">
              <?php echo date('Y');?> - Sistem Penjualan Alat Olahraga Berbasis Web | 
              By <a href="https://duamasachannel.blogspot.com" style="color:yellow;font-weight:700;" target="_blank">Ruslan Ramdani</a>
              <a href="#" class="go-top">
